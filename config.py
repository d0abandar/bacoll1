...
class Config:
    ...
    ADMIN = os.environ.get("5774575572", '')
    SUDO = [int(admin) for admin in (ADMIN).split()] # Exclusive for heroku vars configuration.
    ADMINS = [int(admin) for admin in (ADMIN).split()] #group admins will be appended to this list.
    API_ID = int(os.environ.get("12050714", ''))
    API_HASH = os.environ.get("08f1a315f287b51656a25e99966ac0e7", "")
    BOT_TOKEN = os.environ.get("5665918097:AAHqEvLD416rsy7jsjoUKYnlTl4qtw9WNiA", "")     
    SESSION = os.environ.get("BQABAqznpw5yF4FrPvVzoL4QljP-FcxJFsL-mNb0paAAUkyWJ2G8EhEjjWw2tmZWK9vH3ptzPoWAp8_o_az8dlreI76KbvYx7qhDglHiHfWhFJMYybhgbplc2XIb50av7EYHDRYodclUf3r5YblZDxsaRMfDUpSckGoh_58cnY_dPy5Ik22J9clSVQoCwjhkNb4yyPyRU36Sy926PwoLr3CidDfMP6nT4bDc04Puh-R6s6uYj5M-D0U4YLR71BXes23ePTmJhc-Gd-AB6aOm_PadRIohUqppfdmCfp98RaTAQTCBtr9ulq9ZxjRPcfAJ_NFq9xPFFMpt1olaRDJm79WVAAAAAVgxB9QA", "")

    #Stream Chat and Log Group
    CHAT = int(os.environ.get("-1001740701212", ""))
